...
import 'package:shiyo/view/ui/widgets/successful_dialog_box.dart';
...
class _TransactionSuccessfulScreenState
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 3)).then((value) => Navigator.push(context,
        MaterialPageRoute(builder: (context) => const DashboardLightScreen())));
    super.initState();
  }
